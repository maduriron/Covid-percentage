...
model_paths = ["/home/jovyan/checkpoints/model_extended_resnest101_fold5_softargmax_&_regr_&_hp/model_5_49.pth",
              "/home/jovyan/checkpoints/model_extended_resnest101_fold5_softargmax_&_regr_&_hp/model_5_48.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold5_softargmax_&_regr_&_hp/model_5_47.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold5_softargmax_&_regr_&_hp/model_5_46.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold5_softargmax_&_regr_&_hp/model_5_45.pth",

               "/home/jovyan/checkpoints/model_extended_resnest101_fold2_softargmax_&_regr_&_hp/model_2_49.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold2_softargmax_&_regr_&_hp/model_2_48.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold2_softargmax_&_regr_&_hp/model_2_47.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold2_softargmax_&_regr_&_hp/model_2_46.pth",
               "/home/jovyan/checkpoints/model_extended_resnest101_fold2_softargmax_&_regr_&_hp/model_2_45.pth",
              ]
...
for model_path in tqdm(model_paths):
    ...
    with torch.no_grad():
        for batch in dataloader_test:
            ...
            prediction_index = softargmax(prediction_classes).item() # class predicted
...
with open("./dicts/d_extended_resnest101_softargmax&regr&hp_1_05_2.json", "w") as fhandle:
    json.dump(d, fhandle)